    ...
    <div className="class">
      ...
      <div className="class-header-info">
        ...
        <div className="class-info">
            <ShowClassDetails title={'Students'} value={totalStudentsNumber} color={"#ffbc00"} icon={"fa-solid fa-user-group"}/>
            <ShowClassDetails title={'Teachers'} value={0} color={"#229edb"} icon={"fa-solid fa-person-chalkboard"}/>
            <ShowClassDetails title={'Grade'} value={grade} color={"#60ff00"} icon={"fa-solid fa-graduation-cap"}/>
            <ShowClassDetails title={'Gender'} value={gender} color={"#ff0000"} icon={"bi bi-person-fill-exclamation"}/>
        </div>
      </div>
      <div className="class-body-info">
        <div className="teachers-info">
          ...
          <div className="teacher-name">
            ...
            { <p style={{color: 'red' , fontWeight: '400' , fontSize: '16px' }}>There are no teachers yet ...</p>}
          </div>
        </div>
        <div className="students-info">
          ...
          <div className="students-name">
            {students.map((student) => {
              ...
              return (
                <span key={id} className="studnet-tage">
                  {name} {lastName}
                </span>
              );
            })}
            { totalStudentsNumber == 0 && <p style={{color: 'red' , fontWeight: '400' , fontSize: '16px' }}>There are no students yet ...</p>}
          </div>
        </div>
      </div>
    </div>
