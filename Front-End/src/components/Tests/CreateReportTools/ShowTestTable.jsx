            ...
            <table>
                <thead  style={{position: 'relative' }}>                    
                    <tr>
                        ...
                        <th style={{...thStyle,border: 'none' , padding: '15px' }}>Correction</th>
                    </tr>
                </thead>
                <tbody>
                    {
                        tests.map( (testMark,index) => {           
                                ...
                                const {correctionDate,subject,title} = test
                                return <tr style={{ textAlign: 'center' ,backgroundColor: index % 2 ? 'white' : 'trasnparetn',borderBottom: '2px solid #f3f1f1d7' ,transition: '.3s'}} className="hovering-row" key={index} >
                                            ...
                                            <td style={{padding: '10px' , margin: '5px 0' , border: 'none' }}>{mark}</td>
                                            ...
                                            <td style={{padding: '10px' , margin: '5px 0' , border: 'none' }}>{format(new Date(correctionDate), "yyyy / MM / dd")}</td>
                                        </tr>
                        })
                    }
                </tbody>
