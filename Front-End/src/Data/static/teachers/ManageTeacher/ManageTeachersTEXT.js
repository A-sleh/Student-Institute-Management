...
export const ManageTeachersTEXT  = {
    arabic : {
        subjectsTitle: 'المواد' ,
        classesTitle: 'الشعب' ,
        teacherTitleInfo: 'معلومات الأستاذ' ,
        teacherSubTitle: 'الأستاذ' ,
        addNewSubjectBtn: 'إضافة ماده جديده' ,
        addNewClassBtn: 'إضافة شعبة جديده' ,
    ...
    english : {
        ...
        teacherTitleInfo: 'Teacher Information' ,
