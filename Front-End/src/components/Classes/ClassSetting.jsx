...
export default function ClassSetting({ classDetails ,setDeleteClass}) {
  ...
  const { id ,title, capacity, gender, grade, students } = classDetails;
  ...
  return (
    <>
    { deleteModal && <DeleteModal element={title} id={id} type={'class'}  setDeleteModal={setDeleteModal} setSuccessDelete={setDeleteClass}/>}
        ...
        >
          ...
          >
            ...
            <button
              ...
              onClick={()=>{setUpdateBtnClicked(true)}}
            >
              Update
            </button>
          </div>
